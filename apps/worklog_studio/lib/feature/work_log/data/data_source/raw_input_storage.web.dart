...
class RawInputStorageWeb implements InputStorage {
...
InputStorage getRawInputStorage() => RawInputStorageWeb();
...
Если хочешь, следующим шагом я могу:
	...
	•	или помочь вынести всё это за RawInputStorage так, чтобы web/desktop вообще не знали друг о друге.
*/
