...
/// В данном случае используется в Row
@immutable
class RowBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
    ...
    children: List<Widget>.generate(separatorBuilder != null ? _computeActualChildCount(itemCount) : itemCount, (
      index,
    ) {
